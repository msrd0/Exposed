...
fun dateTimeParam(value: ZonedDateTime, withTimezone : Boolean): Expression<ZonedDateTime> = QueryParameter(value, DateTimeColumnType(withTimezone))
...
fun dateTimeLiteral(value: ZonedDateTime, withTimezone : Boolean) : LiteralOp<ZonedDateTime> = LiteralOp(DateTimeColumnType(withTimezone), value)
